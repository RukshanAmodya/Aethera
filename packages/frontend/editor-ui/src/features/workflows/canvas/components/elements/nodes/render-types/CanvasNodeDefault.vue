...
.node {
	...
	box-shadow:
		0 2px 8px -1px light-dark(rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.4)),
		0 1px 2px 0 light-dark(rgba(0, 0, 0, 0.03), rgba(0, 0, 0, 0.2));
	transition:
	...
	&:hover {
		...
		box-shadow:
			0 8px 18px -2px light-dark(rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.5)),
			0 2px 4px 0 light-dark(rgba(0, 0, 0, 0.04), rgba(0, 0, 0, 0.25));
	}
